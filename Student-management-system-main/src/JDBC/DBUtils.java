...
public class DBUtils {
	...
	public static Connection getConnection() throws ClassNotFoundException, SQLException {
		...
		String url = "jdbc:mysql://localhost:3306/stumansys?useUnicode=true&characterEncoding=utf8&useSSL=false&serverTimezone=GMT&allowPublicKeyRetrieval=true";
		String username = "root";
		String password = "976170425";
